  ...
  return (
    <div className="flex flex-col h-screen max-w-2xl mx-auto">
      <header className="p-4 border-b">
        <h1 className="text-lg font-semibold">UCP Multi-Store Shopping</h1>
        <p className="text-sm text-gray-500">Search and shop across multiple stores</p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t flex gap-2">
        <input
          ...
          placeholder="Search products across stores or start shopping..."
